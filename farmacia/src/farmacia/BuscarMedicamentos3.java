 ...
 * @author Personal
 */
public class BuscarMedicamentos3 extends javax.swing.JFrame {

    /**
     * Creates new form BuscarMedicamentos
     */
    public BuscarMedicamentos3() {
        initComponents();
            ...
            public void valueChanged(ListSelectionEvent lse) {
                if (tblMedicamentos.getSelectedRow() != -1) {//condicion para verificar si algo esta seleccionado
                    int fila = tblMedicamentos.getSelectedRow();
                        RecepcionMed.txtCodigoMed.setText(tblMedicamentos.getValueAt(fila, 0).toString().trim());
                    RecepcionMed.txtNombreMed.setText(tblMedicamentos.getValueAt(fila, 1).toString().trim());
                       RecepcionMed.txtPresentacion.setText(tblMedicamentos.getValueAt(fila, 8).toString().trim());
