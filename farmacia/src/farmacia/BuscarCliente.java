        ...
        tblClientes.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent lse) {
                if (tblClientes.getSelectedRow() != -1) {//condicion para verificar si algo esta seleccionado
                    ...
                    Venta.txtCedulaCli.setText(tblClientes.getValueAt(fila, 0).toString().trim());
                    Venta.txtNombreCli.setText(tblClientes.getValueAt(fila, 1).toString().trim()+" "+tblClientes.getValueAt(fila, 3).toString().trim());
                                   }
            }
        });
    }
