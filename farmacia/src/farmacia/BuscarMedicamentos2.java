 ...
 * @author Personal
 */
public class BuscarMedicamentos2 extends javax.swing.JFrame {

    /**
     * Creates new form BuscarMedicamentos
     */
    public BuscarMedicamentos2() {
        initComponents();
        ...
        tblMedicamentos.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent lse) {
                if (tblMedicamentos.getSelectedRow() != -1) {//condicion para verificar si algo esta seleccionado
                    ...
                    Venta.txtCodigoMed.setText(tblMedicamentos.getValueAt(fila, 0).toString().trim());
                    Venta.txtNombreMEd.setText(tblMedicamentos.getValueAt(fila, 1).toString().trim());
                       Venta.txtStock.setText(tblMedicamentos.getValueAt(fila, 7).toString().trim());
                    Venta.txtCostoVenta.setText(tblMedicamentos.getValueAt(fila, 11).toString().trim());
...
//
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarMedicamentos2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new BuscarMedicamentos2().setVisible(true);
            }
        });
    }
