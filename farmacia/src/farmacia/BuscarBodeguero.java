 ...
 * @author Personal
 */
public class BuscarBodeguero extends javax.swing.JFrame {

    /**
     * Creates new form BuscarBodeguero
     */
    public BuscarBodeguero() {
        initComponents();
        
          this.setTitle("Buscar Bodeguero");
//        bloquear();
        cargarTabla("");
        String nombre1,apellido1,nombreCompleto;
         tblBodegueros.getSelectionModel().addListSelectionListener(new ListSelectionListener() {

            @Override
            public void valueChanged(ListSelectionEvent lse) {
                if (tblBodegueros.getSelectedRow() != -1) {//condicion para verificar si algo esta seleccionado
                    int fila = tblBodegueros.getSelectedRow();
                    Compra.txtCedulaBod.setText(tblBodegueros.getValueAt(fila, 0).toString().trim());
                   Compra.txtNombreBod.setText(tblBodegueros.getValueAt(fila, 1).toString().trim()+" "+tblBodegueros.getValueAt(fila, 3).toString().trim());
   ...
   DefaultTableModel modelo;
    ...
    public void cargarTabla(String dato) {
        String[] titulos = {"Cédula", "Nombre1", "Nombre2", "Apellido1", "Apellido2", "Teléfono", "Direccion","Administrador"};
        String[] registros = new String[7];
        modelo = new DefaultTableModel(null, titulos);
        tblBodegueros.setModel(modelo);
    ...
    private void initComponents() {
        ...
        tblBodegueros = new javax.swing.JTable();
        ...
        tblBodegueros.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        tblBodegueros.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jScrollPane1.setViewportView(tblBodegueros);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarBodeguero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new BuscarBodeguero().setVisible(true);
            }
        });
    }
    ...
    public static javax.swing.JTable tblBodegueros;
